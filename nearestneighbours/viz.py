...
if len(sys.argv) == 4:
    ...
    if space=='reducedcolors':
        semanticspace=utils.readDM("data/reducedcolors.dm")
    if space =='fullcolors':
    ...
    utils.run_PCAneighbours(semanticspace,[word]+english_neighbours,"output/english_neighbours"+word+space+".png")